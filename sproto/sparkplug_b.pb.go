...
type Payload_Metric struct {
	...
	Alias        *uint64                `protobuf:"varint,2,opt,name=alias" json:"alias,omitempty"`                                   // Metric alias - tied to name on birth and included in all later DATAmessages
...
const file_sparkplug_b_proto_rawDesc = "" +
	"\n" +
	"\x11sparkplug_b.proto\x12\x05proto\"\xb3\x19\n" +
	"\aPayload\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x04R\ttimestamp\x12/\n" +
	"\ametrics\x18\x02 \x03(\v2\x15.proto.Payload.MetricR\ametrics\x12\x10\n" +
	"\x03seq\x18\x03 \x01(\x04R\x03seq\x12\x12\n" +
	"\x04uuid\x18\x04 \x01(\tR\x04uuid\x12\x12\n" +
	"\x04body\x18\x05 \x01(\fR\x04body\x1a\x88\x05\n" +
	"\bTemplate\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12/\n" +
	"\ametrics\x18\x02 \x03(\v2\x15.proto.Payload.MetricR\ametrics\x12A\n" +
	"\n" +
	"parameters\x18\x03 \x03(\v2!.proto.Payload.Template.ParameterR\n" +
	"parameters\x12!\n" +
	"\ftemplate_ref\x18\x04 \x01(\tR\vtemplateRef\x12#\n" +
	"\ris_definition\x18\x05 \x01(\bR\fisDefinition\x1a\x9b\x03\n" +
	"\tParameter\x12\x12\n" +
	...
	"\fstring_value\x18\b \x01(\tH\x00R\vstringValue\x12d\n" +
	"\x0fextension_value\x18\t \x01(\v29.proto.Payload.Template.Parameter.ParameterValueExtensionH\x00R\x0eextensionValue\x1a#\n" +
	"\x17ParameterValueExtension*\b\b\x01\x10\x80\x80\x80\x80\x02B\a\n" +
	"\x05value*\b\b\x06\x10\x80\x80\x80\x80\x02\x1a\xe2\x04\n" +
	"\aDataSet\x12$\n" +
	...
	"\x04rows\x18\x04 \x03(\v2\x1a.proto.Payload.DataSet.RowR\x04rows\x1a\xf4\x02\n" +
	...
	"\fstring_value\x18\x06 \x01(\tH\x00R\vstringValue\x12d\n" +
	"\x0fextension_value\x18\a \x01(\v29.proto.Payload.DataSet.DataSetValue.DataSetValueExtensionH\x00R\x0eextensionValue\x1a!\n" +
	"\x15DataSetValueExtension*\b\b\x01\x10\x80\x80\x80\x80\x02B\a\n" +
	"\x05value\x1aP\n" +
	"\x03Row\x12?\n" +
	"\belements\x18\x01 \x03(\v2#.proto.Payload.DataSet.DataSetValueR\belements*\b\b\x02\x10\x80\x80\x80\x80\x02*\b\b\x05\x10\x80\x80\x80\x80\x02\x1a\xb9\x04\n" +
	...
	"\fdouble_value\x18\x06 \x01(\x01H\x00R\vdoubleValue\x12%\n" +
	"\rboolean_value\x18\a \x01(\bH\x00R\fbooleanValue\x12#\n" +
	"\fstring_value\x18\b \x01(\tH\x00R\vstringValue\x12I\n" +
	"\x11propertyset_value\x18\t \x01(\v2\x1a.proto.Payload.PropertySetH\x00R\x10propertysetValue\x12O\n" +
	"\x12propertysets_value\x18\n" +
	" \x01(\v2\x1e.proto.Payload.PropertySetListH\x00R\x11propertysetsValue\x12^\n" +
	"\x0fextension_value\x18\v \x01(\v23.proto.Payload.PropertyValue.PropertyValueExtensionH\x00R\x0eextensionValue\x1a\"\n" +
	"\x16PropertyValueExtension*\b\b\x01\x10\x80\x80\x80\x80\x02B\a\n" +
	"\x05value\x1aa\n" +
	"\vPropertySet\x12\x12\n" +
	"\x04keys\x18\x01 \x03(\tR\x04keys\x124\n" +
	"\x06values\x18\x02 \x03(\v2\x1c.proto.Payload.PropertyValueR\x06values*\b\b\x03\x10\x80\x80\x80\x80\x02\x1aY\n" +
	"\x0fPropertySetList\x12<\n" +
	"\vpropertyset\x18\x01 \x03(\v2\x1a.proto.Payload.PropertySetR\vpropertyset*\b\b\x02\x10\x80\x80\x80\x80\x02\x1a\xef\x01\n" +
	"\bMetaData\x12\"\n" +
	...
	"\vdescription\x18\b \x01(\tR\vdescription*\b\b\t\x10\x80\x80\x80\x80\x02\x1a\xb8\x06\n" +
	"\x06Metric\x12\x12\n" +
	...
	"\ais_null\x18\a \x01(\bR\x06isNull\x123\n" +
	"\bmetadata\x18\b \x01(\v2\x17.proto.Payload.MetaDataR\bmetadata\x12:\n" +
	"\n" +
	"properties\x18\t \x01(\v2\x1a.proto.Payload.PropertySetR\n" +
	"properties\x12\x1d\n" +
	"\tint_value\x18\n" +
	...
	"bytesValue\x12=\n" +
	"\rdataset_value\x18\x11 \x01(\v2\x16.proto.Payload.DataSetH\x00R\fdatasetValue\x12@\n" +
	"\x0etemplate_value\x18\x12 \x01(\v2\x17.proto.Payload.TemplateH\x00R\rtemplateValue\x12U\n" +
	"\x0fextension_value\x18\x13 \x01(\v2*.proto.Payload.Metric.MetricValueExtensionH\x00R\x0eextensionValue\x1a \n" +
...
var file_sparkplug_b_proto_goTypes = []any{
	...
	(*Payload_Template)(nil),                                   // 2: proto.Payload.Template
	(*Payload_DataSet)(nil),                                    // 3: proto.Payload.DataSet
	(*Payload_PropertyValue)(nil),                              // 4: proto.Payload.PropertyValue
	(*Payload_PropertySet)(nil),                                // 5: proto.Payload.PropertySet
	(*Payload_PropertySetList)(nil),                            // 6: proto.Payload.PropertySetList
	(*Payload_MetaData)(nil),                                   // 7: proto.Payload.MetaData
	(*Payload_Metric)(nil),                                     // 8: proto.Payload.Metric
	(*Payload_Template_Parameter)(nil),                         // 9: proto.Payload.Template.Parameter
	(*Payload_Template_Parameter_ParameterValueExtension)(nil), // 10: proto.Payload.Template.Parameter.ParameterValueExtension
	(*Payload_DataSet_DataSetValue)(nil),                       // 11: proto.Payload.DataSet.DataSetValue
	(*Payload_DataSet_Row)(nil),                                // 12: proto.Payload.DataSet.Row
	(*Payload_DataSet_DataSetValue_DataSetValueExtension)(nil), // 13: proto.Payload.DataSet.DataSetValue.DataSetValueExtension
	(*Payload_PropertyValue_PropertyValueExtension)(nil),       // 14: proto.Payload.PropertyValue.PropertyValueExtension
	(*Payload_Metric_MetricValueExtension)(nil),                // 15: proto.Payload.Metric.MetricValueExtension
}
var file_sparkplug_b_proto_depIdxs = []int32{
	8,  // 0: proto.Payload.metrics:type_name -> proto.Payload.Metric
	8,  // 1: proto.Payload.Template.metrics:type_name -> proto.Payload.Metric
	9,  // 2: proto.Payload.Template.parameters:type_name -> proto.Payload.Template.Parameter
	12, // 3: proto.Payload.DataSet.rows:type_name -> proto.Payload.DataSet.Row
	5,  // 4: proto.Payload.PropertyValue.propertyset_value:type_name -> proto.Payload.PropertySet
	6,  // 5: proto.Payload.PropertyValue.propertysets_value:type_name -> proto.Payload.PropertySetList
	14, // 6: proto.Payload.PropertyValue.extension_value:type_name -> proto.Payload.PropertyValue.PropertyValueExtension
	4,  // 7: proto.Payload.PropertySet.values:type_name -> proto.Payload.PropertyValue
	5,  // 8: proto.Payload.PropertySetList.propertyset:type_name -> proto.Payload.PropertySet
	7,  // 9: proto.Payload.Metric.metadata:type_name -> proto.Payload.MetaData
	5,  // 10: proto.Payload.Metric.properties:type_name -> proto.Payload.PropertySet
	3,  // 11: proto.Payload.Metric.dataset_value:type_name -> proto.Payload.DataSet
	2,  // 12: proto.Payload.Metric.template_value:type_name -> proto.Payload.Template
	15, // 13: proto.Payload.Metric.extension_value:type_name -> proto.Payload.Metric.MetricValueExtension
	10, // 14: proto.Payload.Template.Parameter.extension_value:type_name -> proto.Payload.Template.Parameter.ParameterValueExtension
	13, // 15: proto.Payload.DataSet.DataSetValue.extension_value:type_name -> proto.Payload.DataSet.DataSetValue.DataSetValueExtension
	11, // 16: proto.Payload.DataSet.Row.elements:type_name -> proto.Payload.DataSet.DataSetValue
